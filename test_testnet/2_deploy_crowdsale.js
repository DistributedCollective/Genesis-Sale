...
const csovAdmin = '0x7BE508451Cd748Ba55dcBE75c8067f9420909b49'; /// Need to Update this address
...
module.exports = async function (deployer) {
    ...
    await CSOVTokenInstance.setSaleAdmin(crowdsale.address, adminWallet);
    console.log(
