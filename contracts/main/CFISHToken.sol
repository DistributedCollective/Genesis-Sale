...
contract CFISHToken is ERC20, Ownable {
    using SafeMath for uint256;

    string private constant NAME = "CBabelFISHToken"; // Token Name
    string private constant SYMBOL = "CFISH"; // Token Symbol
     ...
     * construction.
     */
    constructor(uint256 totalSupply_, address payable _cfishAdmin)
        public
        ERC20(NAME, SYMBOL)
    {
        transferOwnership(_cfishAdmin);
        _mint(_cfishAdmin, totalSupply_);
    }
