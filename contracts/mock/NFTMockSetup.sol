...
contract NFTMockSetup {
    ...
    function getBalance (address _owner) public view returns(uint256, uint256, uint256, uint256, uint256) {
            return(
    ...
    function getNFTAddress() public view returns(address, address, address, address, address ){
        return (NFAdress[0],NFAdress[1],NFAdress[2],NFAdress[3],NFAdress[4]);
        }
}